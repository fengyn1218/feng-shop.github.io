        ...
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang" >
                        <input id="username" name="username" type="text" class="itxt" placeholder="邮箱/用户名/已验证手机" style="height: 42px">
                        <input id="password" name="password" type="password" class="itxt" placeholder="密码"style="height: 42px">
                        <input id="verification" name="verification" type="text" class="itxt" placeholder="验证码"
                               style="width: 119px ;height: 42px">
                        <img id="validateCode" src="/verification" style="float: right; padding-right: 23px ;cursor:pointer" title="看不清，点击切换"/>
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox">
